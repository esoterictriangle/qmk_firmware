...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	* |-----|-----|   +---------+-----+-----+-----+-----+-+---+-----+-----------+-------------------------------+
	* |COPY |PASTE|   |RCTL |LGUI |LALT |TT(2)|   SPACE   |       SPACE     |TT(2)|RALT |RCTL |LEFT |DOWN |RGHT |
	* +-----------+   +-----------------------------------+-----------------------------------------------+-----+
	*/
  ...
  /*
	...
	* | ESC |TASK |   | GRV |  1  |  2  |  3  |  4  |  5  |  6  |  7  |  8  |  9  |  0  |MINS | EQL |BSPC | DEL |
	* |-----|-----|   +-----------------------------------------------------------------------------------------+
	* |HOME | END |   | TAB |  Q  |  W  |  F  |  P  |  G  |  J  |  L  |  U  |  Y  | SCLN|LBRC |RBRC |BSLS |PSCR |
	* |-----|-----|   +-----+-+---+-+---+-+---+-+---+-+---+-+---+-+---+-+---+-+---+-------------+---------------+
	* |NTAB | F5  |   | CAPS  |  A  |  R  |  S  |  T  |  D  |  H  |  N  |  E  |  I  |  O  |QUOT |   ENT   |PGUP |
	* |-----|-----|   +-------+-+---+-+---+-+---+-+---+-+---+-+---+-+---+-----+-+---------------+---+-----------+
	* | KEE |UNDO |   |   LSFT   |  Z  |  X  |  C  |  V  |  B  |  K  |  M  |COMM | DOT |SLSH | RSFT | UP  |PGDN |
	* |-----|-----|   +---------+-----+-----+-----+-----+-+---+-----+-----------+-------------------------------+
	* |COPY |PASTE|   |RCTL |LGUI |LALT |TT(2)|   SPACE   |       SPACE     |TT(2)|RALT |RCTL |LEFT |DOWN |RGHT |
	* +-----------+   +-----------------------------------+-----------------------------------------------+-----+
	*/
